 ...
 */
object MSALUtil {
    private val LOGGER = java.util.logging.Logger.getLogger(MSALUtil::class.java.name)
    ...
    fun acquireToken(fromActivity: Activity, scopes: Array<String>,
                     loginHint: String?, callback: AuthCallback) {
...
//            val msalLogger = Logger.getInstance()
